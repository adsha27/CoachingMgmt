...
const JEE: ExamConfig = {
  ...
  jsonLdDesc: "Verified JEE Main and JEE Advanced coaching teachers on EduConnect",
  ...
  seoPara2: "All teachers on EduConnect are manually verified by our team before appearing on the platform. Sessions happen via Google Meet with automatic reminders sent 1 hour before.",
  theme: "indigo",
};
