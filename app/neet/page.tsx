...
export const metadata: Metadata = {
  ...
  twitter: { card: "summary", title: "NEET Coaching Online | Novus Classes" },
...
const NEET: ExamConfig = {
  ...
  seoPara1: "NEET UG requires deep conceptual understanding of Biology, Chemistry, and Physics. Novus Classes connects aspiring medical students with verified teachers who specialize in NEET preparation. Join group batches to learn with peers, or book dedicated 1-on-1 sessions for focused doubt clearing.",
  seoPara2: "All teachers are manually reviewed by the Novus Classes team. Sessions happen via Google Meet with automatic reminders sent 1 hour before your class.",
  theme: "emerald",
};
